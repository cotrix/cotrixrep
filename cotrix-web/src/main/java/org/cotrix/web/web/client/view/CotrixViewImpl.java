...
public class CotrixViewImpl<T> extends Composite implements CotrixView<T> {

	@UiTemplate("CotrixView.ui.xml")
	interface CotrixViewUiBinder extends UiBinder<Widget, CotrixViewImpl> {
	}

	private static CotrixViewUiBinder uiBinder = GWT.create(CotrixViewUiBinder.class);
