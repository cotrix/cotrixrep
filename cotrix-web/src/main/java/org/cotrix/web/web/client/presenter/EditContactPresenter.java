...
public class EditContactPresenter implements Presenter {
	...
	public EditContactPresenter(CotrixServiceAsync rpcService, HandlerManager eventBus, Display display) {
	...
	public EditContactPresenter(CotrixServiceAsync rpcService, HandlerManager eventBus, Display display, String id) {
		this.rpcService = rpcService;
		this.eventBus = eventBus;
		this.display = display;
		bind();
