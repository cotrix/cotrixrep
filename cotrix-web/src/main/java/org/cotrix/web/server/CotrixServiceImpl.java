...
import org.cotrix.web.web.client.CotrixService;

import com.google.gwt.user.server.rpc.RemoteServiceServlet;

@SuppressWarnings("serial")
public class CotrixServiceImpl extends RemoteServiceServlet implements CotrixService {
	...
	private final String[] contactsEmailData = new String[] { "mark@example.com", "hollie@example.com",
			...
			"elba@example.com", "claudio@example.com", "dena@example.com", "brasilsp@example.com",
	...
	public CotrixServiceImpl() {
		initCotrix();
	}

	private void initCotrix() {
	...
	public ArrayList<ContactDetails> deleteCotrix(ArrayList<String> ids) {
