...
public class Users {
	...
	public static RoleModel USER = user().name("user").fullName("New User Role").can(VIEW,LOGOUT)
			.buildAsModel();

	public static RoleModel MANAGER = user().name("manager").fullName("Manager Role").can(IMPORT).buildAsModel();
