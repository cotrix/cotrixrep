 ...
 * </ul>
 */
public class TableImportDirectives implements ImportDirectives {
	 ...
	 */
	public TableImportDirectives(Column column) {
		this.column = column;
	}
	 ...
	 * @param column the code column name
	 */
	public TableImportDirectives(QName name) {
	 ...
	 * @param column the code column name
	 */
	public TableImportDirectives(String column) {
	 ...
	 */
	public TableImportDirectives name(QName name) {
		this.name = name;
		return this;
	}
	 ...
	 * @return these directives
	 */
	public TableImportDirectives name(String name) {
	 ...
	 * @return these directives
	 */
	public TableImportDirectives attributes(List<Attribute> attributes) {
	 ...
	 * @return these directives
	 */
	public TableImportDirectives attributes(Attribute ... attributes) {
	 ...
	 * @return these directives
	 */
	public TableImportDirectives add(ColumnDirectives directive) {
	 ...
	 * @return these directives
	 */
	public TableImportDirectives mode(MappingMode mode) {
		this.mode = mode;
		return this;
	}
