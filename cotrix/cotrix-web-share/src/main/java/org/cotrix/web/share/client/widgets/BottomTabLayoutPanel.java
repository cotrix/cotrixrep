 ...
 * </pre>
 */
public class BottomTabLayoutPanel extends ResizeComposite implements HasWidgets,
...
HasBeforeSelectionHandlers<Integer>, HasSelectionHandlers<Integer> {
	...
	private class Tab extends SimplePanel {
		...
		public boolean remove(Widget w) {
			...
			if (replacingWidget || index < 0) {
				...
				return BottomTabLayoutPanel.this.remove(index);
			}
		}
	...
	private class TabbedDeckLayoutPanel extends DeckLayoutPanel {
		...
		public boolean remove(Widget w) {
			 ...
			 */
			return BottomTabLayoutPanel.this.remove(w);
		}
	 ...
	 */
	public BottomTabLayoutPanel(double barHeight, Unit barUnit) {
		DockLayoutPanel panel = new DockLayoutPanel(barUnit);
		//LayoutPanel panel = new LayoutPanel();
		initWidget(panel);

		// Add the tab bar to the panel.
		panel.addSouth(tabBar, barHeight);
