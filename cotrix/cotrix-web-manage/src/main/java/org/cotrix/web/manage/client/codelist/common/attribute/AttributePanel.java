...
public class AttributePanel extends ItemPanel<UIAttribute> {
	...
	public AttributePanel(UIAttribute attribute, boolean hasDefinition, AttributeDescriptionSuggestOracle oracle, AttributeDefinitionsCache attributeTypesCache, ItemPanelHeader header) {
		super(new AttributeEditor(attribute, hasDefinition, oracle, attributeTypesCache), header);
	}
