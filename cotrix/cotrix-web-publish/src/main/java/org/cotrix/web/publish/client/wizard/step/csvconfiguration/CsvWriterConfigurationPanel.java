 ...
 *
 */
public class CsvWriterConfigurationPanel extends Composite {
	...
	protected enum Separator implements Value {
		...
		CUSTOM("other",(char)0)
		;
		public static LabelProvider<Separator> LABEL_PROVIDER = new LabelProvider<CsvWriterConfigurationPanel.Separator>() {
	...
	protected enum Quote implements Value {
		...
		CUSTOM("other",'o')
		;
		public static LabelProvider<Quote> LABEL_PROVIDER = new LabelProvider<CsvWriterConfigurationPanel.Quote>() {
	...
	private static CsvWriterConfigurationDialogUiBinder uiBinder = GWT.create(CsvWriterConfigurationDialogUiBinder.class);

	interface CsvWriterConfigurationDialogUiBinder extends
	UiBinder<Widget, CsvWriterConfigurationPanel> {
	}
	...
	public CsvWriterConfigurationPanel() {

		separatorField = new EnumListBox<CsvWriterConfigurationPanel.Separator>(Separator.class, Separator.LABEL_PROVIDER);
		quoteField = new EnumListBox<CsvWriterConfigurationPanel.Quote>(Quote.class, Quote.LABEL_PROVIDER);
