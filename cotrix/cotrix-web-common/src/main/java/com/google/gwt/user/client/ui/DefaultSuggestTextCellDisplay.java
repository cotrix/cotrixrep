 ...
 *
 */
public class DefaultSuggestTextCellDisplay extends SuggestTextCellDisplay implements HasAnimation {
	...
	/**
	 * Construct a new {@link DefaultSuggestTextCellDisplay}.
	 */
	...
	@Override
	public void showSuggestions(final SuggestTextCell suggestBox,
